...
const Login: React.FC = () => {
    ...
    return (
        <div className="bg-auth-bg min-h-screen flex justify-center items-center relative p-8 font-source-serif overflow-hidden">
            ...
            <img src="/login.png" alt="Mascot" className="absolute -bottom-1 z-6 pointer-events-none -right-0 w-[250px] hidden lg:block" />

            <div className="bg-auth-card w-full max-w-[1200px] min-h-[720px] rounded-[60px] p-8 md:p-12 relative flex flex-col items-center shadow-2xl border-1.5 border-auth-brown/10">
                ...
                <div className="text-center mb-8">
                    <h1 className="text-4xl md:text-5xl text-auth-brown mb-2 font-bold tracking-tight text-center">Welcome back!</h1>
                </div>
                ...
                <form className="w-full max-w-[380px] flex flex-col gap-5" onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-between items-center text-sm mt-0.5 text-auth-brown font-medium">
                        <label className="flex items-center gap-2 cursor-pointer hover:opacity-80 transition-opacity">
                            <input type="checkbox" className="w-4 h-4 rounded border-auth-brown text-auth-mauve focus:ring-auth-mauve/20" /> remember me
                        </label>
                        <a href="#" className="text-auth-brown no-underline hover:underline">Forget your password?</a>
                    </div>
                ...
                <div className="mt-8 text-sm text-auth-brown/80 font-medium">
                    Don't have an account yet? <Link to="/signup" className="text-auth-purple font-bold no-underline hover:underline ml-1">Sign up</Link>
                </div>
            </div>
        </div>
    );
